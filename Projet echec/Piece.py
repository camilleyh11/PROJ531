...
class Piece: #definition de la classe Pieces 
              #comprend les attributs et les méthodes des pièces d’échecs
    
    def __init__(self,nom='.',couleur=''): #constructeur qui initialise les variables
    ...
    def piece_echec(self): #méthode pour définir les pièces et leurs attributs
        ...
        #im_tour =  pygame.image.load(".jpg")
        im_cavalier = pygame.image.load('cavalier.jpg').convert()
        #im_fou = pygame.image.load(".jpg")
        #im_pion =  pygame.image.load(".jpg")
        #im_roi =  pygame.image.load(".jpg")
        #im_dame = pygame.image.load(".jpg")
